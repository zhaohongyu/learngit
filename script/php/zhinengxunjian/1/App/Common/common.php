...
function __hack_action() {
    $img_url = HOUTAI_IMG_URL;
    $main_url = getUrl("Index/index");
    $html = <<<HTMLSTR
<center>
    <img src="{$img_url}404.jpg" alt="404" width="1024" height="768" border="0" usemap="#Map" />
    <map name="Map" id="Map">
        <area shape="rect" coords="536,363,686,386" href="javascript:history.back();" target="返回上一页" />
        <area shape="rect" coords="537,391,687,416" href="javascript:;" onclick="window.location.href='{$main_url}'" target="返回首页"/>
    </map>
</center>
HTMLSTR;
    echo $html;
...
function kcode($string, $operation = 'DECODE', $key = '', $expiry = 0) {
    ...
    $key = md5($key ? $key : '4kjlj23j4kljklfsd64fa79fnczwer');
